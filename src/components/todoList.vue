<template>
    <div>
        ...
        <div class="selected-section">
            <p class="space"></p>
            <span :class="{ 'select_type': selected == '0','select':true} " @click="selectType('0')">全部</span>
            <span :class="{ 'select_type': selected == '1','select':true} " @click="selectType('1')">已完成</span>
            <span :class="{ 'select_type': selected == '2','select':true} " @click="selectType('2')">未完成</span>
        </div>
    </div>
</template>
